...
public class StringAggregator implements Aggregator {
    ...
    public void mergeTupleIntoGroup(Tuple tup) {
        Field gField = groupByFieldIndex == NO_GROUPING ? UniqueField.getInstance() : tup.getField(groupByFieldIndex);
    ...
    public OpIterator iterator() {
        return new IntegerAggregator.Iterator(groupByFieldType, groups);
    }
}
